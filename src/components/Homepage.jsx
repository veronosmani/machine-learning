...
export default function Homepage(props) {
  ...
  return (
    <main className="flex-1 p-4 flex flex-col gap-3 text-center sm:gap-4 md:gap-5 justify-center">
      ...
      <button onClick={recordingStatus === 'recording' ? stopRecording : startRecording} className="flex items-center specialBtn px-4 py-2 rounded-xl text-base justify-between gap-4 mx-auto w-72 max-w-full my-4">
